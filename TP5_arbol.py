...
# Punto C
# print ('Super heroes cuyo nombre empieza con "C"')
...
# 16. Una empresa de nano satélites dedicada al monitoreo de lotes campo destinados al agro, tiene 
...
# desarrollar un algoritmo que permita comprimir la información para poder enviarla más rápido, 
